...
var file_Lab_2_proto_rawDesc = []byte{
	...
	0x32, 0xb3, 0x01, 0x0a, 0x08, 0x4e, 0x61, 0x6d, 0x65, 0x4e, 0x6f, 0x64, 0x65, 0x12, 0x26, 0x0a,
	0x08, 0x57, 0x72, 0x69, 0x74, 0x65, 0x4c, 0x6f, 0x67, 0x12, 0x0c, 0x2e, 0x70, 0x62, 0x2e, 0x50,
	0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x1a, 0x0c, 0x2e, 0x70, 0x62, 0x2e, 0x52, 0x65, 0x73,
...
var file_Lab_2_proto_depIdxs = []int32{
	...
	2, // 3: pb.NameNode.WriteLog:input_type -> pb.Proposal
	2, // 4: pb.NameNode.FinalProposal:input_type -> pb.Proposal
	0, // 5: pb.NameNode.FileRequest:input_type -> pb.Empty
	5, // 6: pb.NameNode.AddressRequest:input_type -> pb.File
	1, // 7: pb.DataNode.UpploadChunks:output_type -> pb.Response
	3, // 8: pb.DataNode.DowloadChunks:output_type -> pb.Chunk
	1, // 9: pb.DataNode.ProposalRequest:output_type -> pb.Response
	1, // 10: pb.NameNode.WriteLog:output_type -> pb.Response
	2, // 11: pb.NameNode.FinalProposal:output_type -> pb.Proposal
	5, // 12: pb.NameNode.FileRequest:output_type -> pb.File
	6, // 13: pb.NameNode.AddressRequest:output_type -> pb.ChunkAddress
